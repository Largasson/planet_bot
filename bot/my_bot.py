...
def greet_user(update, context):  # update - аргумент - с информацией, пришедшей с платформы Telegram, context - ?
    ...
    update.message.reply_text(
        f" Привет, {context.user_data['emoji']}! Я умею говорить в какой констелляции сейчас находится та или иная планета нашей солнечной системы. "
        f"Могу показать схему созвездий звездного неба, или основных констелляций. "
        f"Можешь спросить меня об этом командой /planet название планеты, /star_map и /const соответственно. "
        f"P.S.: про Землю не спрашивай. Мы на ней и с нее смотрим. А... забыл.. еще умею играть в угадай число. Команда /guess число. ")
